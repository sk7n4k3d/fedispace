...
class LoopsProfile {
  ...
  factory LoopsProfile.fromJson(Map<String, dynamic> json) {
    return LoopsProfile(
      ...
      followersCount: json['followers_count'] as int? ?? json['follower_count'] as int? ?? 0,
      followingCount: json['following_count'] as int? ?? 0,
      videosCount: json['videos_count'] as int? ?? json['post_count'] as int? ?? 0,
...
class LoopsApi {
  ...
  Future<LoopsPaginatedResponse<LoopsVideo>> getAccountFeedWithCursor(
    ...
    debugPrint('[LOOPS API] getAccountFeedWithCursor: starting request for id=$profileId');
    final params = <String, String>{
      'id': videoId.toString(),
  ...
  Future<Map<String, dynamic>> recordFeedImpression({
    ...
    debugPrint('[LOOPS API] recordFeedImpression: starting request for videoId=$videoId');
  ...
  Future<Map<String, dynamic>> recordFeedFeedback({
    ...
    debugPrint('[LOOPS API] recordFeedFeedback: starting request for videoId=$videoId');
  ...
  Future<Map<String, dynamic>> removeFeedFeedback(int videoId) async {
    debugPrint('[LOOPS API] removeFeedFeedback: starting request for videoId=$videoId');
  ...
  Future<Map<String, dynamic>> editVideo(String id, {
    String? caption,
    bool? canDownload,
    bool? canComment,
    bool? isPinned,
  ...
  Future<Map<String, dynamic>> getVideoHistory(String id, {String? cursor}) async {
    debugPrint('[LOOPS API] getVideoHistory: starting request for id=$id');
    final params = <String, String>{};
    if (cursor != null) params['cursor'] = cursor;
    return _get('/api/v1/video/history/$id', queryParams: params.isNotEmpty ? params : null);
  }
  ...
  Future<Map<String, dynamic>> uploadVideo({
    ...
    final request = http.MultipartRequest('POST', _uri('/api/v1/studio/upload'));
  ...
  Future<Map<String, dynamic>> uploadDuet({
    ...
    debugPrint('[LOOPS API] uploadDuet: starting multipart upload for duetId=$duetId');
    final request = http.MultipartRequest('POST', _uri('/api/v1/studio/duet/upload'));
    request.files.add(await http.MultipartFile.fromPath('video', filePath));
  ...
  Future<List<LoopsComment>> getVideoComments(String id, {String? cursor}) async {
  ...
  Future<List<LoopsCommentReply>> getCommentReplies(String videoId, {
    required String commentId,
    String? cursor,
  }) async {
    debugPrint('[LOOPS API] getCommentReplies: starting request for videoId=$videoId commentId=$commentId');
  ...
  Future<List<LoopsComment>> getHiddenComments(String videoId, {String? cursor}) async {
    debugPrint('[LOOPS API] getHiddenComments: starting request for videoId=$videoId');
    final params = <String, String>{};
    if (cursor != null) params['cursor'] = cursor;
  ...
  Future<Map<String, dynamic>> getCommentById(String videoId, String commentId) async {
  ...
  Future<Map<String, dynamic>> getReplyById(String videoId, String replyId) async {
  ...
  Future<Map<String, dynamic>> postComment(String videoId, String text, {String? parentId}) async {
    debugPrint('[LOOPS API] postComment: starting request for videoId=$videoId');
  ...
  Future<Map<String, dynamic>> editComment(String id, {
    required String commentId,
  ...
  Future<Map<String, dynamic>> editCommentReply(String id, {
  ...
  Future<Map<String, dynamic>> likeComment(String videoId, String commentId) async {
  ...
  Future<Map<String, dynamic>> unlikeComment(String videoId, String commentId) async {
  ...
  Future<Map<String, dynamic>> likeCommentReply(String videoId, String parentId, String replyId) async {
  ...
  Future<Map<String, dynamic>> unlikeCommentReply(String videoId, String parentId, String replyId) async {
  ...
  Future<Map<String, dynamic>> deleteCommentReply(String videoId, String parentId, String replyId) async {
  ...
  Future<Map<String, dynamic>> hideComment(String videoId, String commentId) async {
  ...
  Future<Map<String, dynamic>> hideCommentReply(String videoId, String parentId, String replyId) async {
  ...
  Future<Map<String, dynamic>> unhideComment(String videoId, String commentId) async {
  ...
  Future<Map<String, dynamic>> getCommentHistory(String videoId, String commentId, {String? cursor}) async {
  ...
  Future<Map<String, dynamic>> getCommentReplyHistory(String videoId, String commentId, String replyId, {String? cursor}) async {
  ...
  Future<Map<String, dynamic>> getAccountByUsername(String username) async {
    debugPrint('[LOOPS API] getAccountByUsername: starting request for username=$username');
  ...
  Future<Map<String, dynamic>> getFollowers(String id, {String? cursor, String? search}) async {
    debugPrint('[LOOPS API] getFollowers: starting request for id=$id');
    final params = <String, String>{};
    if (cursor != null) params['cursor'] = cursor;
    if (search != null) params['q'] = search;
    return _get('/api/v1/account/followers/$id', queryParams: params.isNotEmpty ? params : null);
  }

  /// GET /api/v1/account/following/{id}
  Future<Map<String, dynamic>> getFollowing(String id, {String? cursor, String? search}) async {
    debugPrint('[LOOPS API] getFollowing: starting request for id=$id');
    final params = <String, String>{};
    if (cursor != null) params['cursor'] = cursor;
    if (search != null) params['q'] = search;
    return _get('/api/v1/account/following/$id', queryParams: params.isNotEmpty ? params : null);
  }

  /// GET /api/v1/account/friends/{id}
  Future<Map<String, dynamic>> getAccountFriends(String id, {String? cursor, String? search}) async {
    debugPrint('[LOOPS API] getAccountFriends: starting request for id=$id');
    final params = <String, String>{};
    if (cursor != null) params['cursor'] = cursor;
    if (search != null) params['q'] = search;
    return _get('/api/v1/account/friends/$id', queryParams: params.isNotEmpty ? params : null);
  }

  /// GET /api/v1/account/suggested/{id}
  Future<Map<String, dynamic>> getAccountSuggestedFollows(String id) async {
    debugPrint('[LOOPS API] getAccountSuggestedFollows: starting request for id=$id');
  ...
  Future<Map<String, dynamic>> hideSuggestion(String profileId) async {
    debugPrint('[LOOPS API] hideSuggestion: starting request for profileId=$profileId');
    return _post('/api/v1/accounts/suggested/hide', body: {'profile_id': profileId});
  }

  /// POST /api/v1/accounts/suggested/unhide
  Future<Map<String, dynamic>> unhideSuggestion(String profileId) async {
    debugPrint('[LOOPS API] unhideSuggestion: starting request for profileId=$profileId');
    return _post('/api/v1/accounts/suggested/unhide', body: {'profile_id': profileId});
  }
  ...
  Future<Map<String, dynamic>> getAccountVideoLikes({String? cursor}) async {
    ...
    final params = <String, String>{};
    if (cursor != null) params['cursor'] = cursor;
    return _get('/api/v1/account/videos/likes', queryParams: params.isNotEmpty ? params : null);
  }

  /// GET /api/v1/account/favourites -- Bookmarked videos.
  Future<Map<String, dynamic>> getBookmarks({String sort = 'latest', int limit = 12, String? cursor}) async {
  ...
  Future<Map<String, dynamic>> getPublicAccountFollowers(String id) async {
    debugPrint('[LOOPS API] getPublicAccountFollowers: starting request for id=$id');
  ...
  Future<Map<String, dynamic>> getPublicAccountFollowing(String id) async {
    debugPrint('[LOOPS API] getPublicAccountFollowing: starting request for id=$id');
  ...
  Future<Map<String, dynamic>> getSystemNotification(String id) async {
    debugPrint('[LOOPS API] getSystemNotification: starting request for id=$id');
  ...
  Future<Map<String, dynamic>> getPublicSystemNotification(String id) async {
    debugPrint('[LOOPS API] getPublicSystemNotification: starting request for id=$id');
  ...
  /// GET /api/v1/search
  Future<Map<String, dynamic>> search(String query, {String? type, int? limit, String? cursor}) async {
  ...
  Future<LoopsPaginatedResponse<LoopsVideo>> getTagFeed(String tagId, {String? cursor, int? limit}) async {
  ...
  Future<LoopsPaginatedResponse<LoopsVideo>> getVideoTagFeed(String tagName, {String? cursor, int? limit}) async {
    debugPrint('[LOOPS API] getVideoTagFeed: starting request for tag=$tagName');
    final params = <String, String>{};
    if (cursor != null) params['cursor'] = cursor;
    if (limit != null) params['limit'] = limit.toString();
  ...
  Future<Map<String, dynamic>> autocompleteTags(String query) async {
    debugPrint('[LOOPS API] autocompleteTags: starting request for query=$query');
  ...
  Future<Map<String, dynamic>> autocompleteAccounts(String query) async {
    debugPrint('[LOOPS API] autocompleteAccounts: starting request for query=$query');
  ...
  Future<LoopsPaginatedResponse<LoopsVideo>> getSoundFeed(String id, {required String key, String? cursor}) async {
  ...
  Future<Map<String, dynamic>> getStudioPosts({String? search, int limit = 10, String? cursor}) async {
  ...
  Future<Map<String, dynamic>> getStudioPlaylistPosts({String? search, int limit = 10, String? cursor}) async {
  ...
  Future<Map<String, dynamic>> getPlaylists({String? search, int limit = 10, String? cursor}) async {
  ...
  Future<Map<String, dynamic>> createPlaylist({required String name, String? description, String visibility = 'public'}) async {
  ...
  Future<Map<String, dynamic>> updatePlaylist(String id, {String? name, String? description, String? visibility}) async {
  ...
  Future<Map<String, dynamic>> getPlaylistVideos(String playlistId, {int limit = 10, String? cursor}) async {
    debugPrint('[LOOPS API] getPlaylistVideos: starting request for playlistId=$playlistId');
    final params = <String, String>{'limit': limit.toString()};
    if (cursor != null) params['cursor'] = cursor;
    return _get('/api/v1/studio/playlists/$playlistId/videos', queryParams: params);
  }

  /// POST /api/v1/studio/playlists/{id}/videos
  Future<Map<String, dynamic>> addVideoToPlaylist(String playlistId, int videoId, {int? position}) async {
  ...
  Future<Map<String, dynamic>> removeVideoFromPlaylist(String playlistId, String videoId) async {
  ...
  Future<Map<String, dynamic>> reorderPlaylistVideos(String playlistId, List<int> videoIds) async {
    debugPrint('[LOOPS API] reorderPlaylistVideos: starting request');
    return _put('/api/v1/studio/playlists/$playlistId/reorder', body: {'video_ids': videoIds});
  }
  ...
  Future<Map<String, dynamic>> updatePrivacySettings(Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> setBirthdate(String birthDate) async {
    ...
    return _post('/api/v1/account/settings/birthdate', body: {'birth_date': birthDate});
  }
  ...
  Future<Map<String, dynamic>> updateAvatar(String filePath, {Map<String, dynamic>? coordinates}) async {
    debugPrint('[LOOPS API] updateAvatar: starting multipart upload');
    final request = http.MultipartRequest('POST', _uri('/api/v1/account/settings/update-avatar'));
    request.files.add(await http.MultipartFile.fromPath('avatar', filePath));
    if (coordinates != null) request.fields['coordinates'] = jsonEncode(coordinates);
  ...
  Future<Map<String, dynamic>> updatePassword(String password, String passwordConfirmation) async {
  ...
  Future<Map<String, dynamic>> getBlockedAccounts({String? cursor, String? search}) async {
    debugPrint('[LOOPS API] getBlockedAccounts: starting request');
    final params = <String, String>{};
    if (cursor != null) params['cursor'] = cursor;
    if (search != null) params['q'] = search;
    return _get('/api/v1/account/settings/blocked-accounts', queryParams: params.isNotEmpty ? params : null);
  }

  /// POST /api/v1/account/settings/blocked-account-search
  Future<Map<String, dynamic>> searchBlockableAccounts(String query) async {
    debugPrint('[LOOPS API] searchBlockableAccounts: starting request for query=$query');
    return _post('/api/v1/account/settings/blocked-account-search', body: {'q': query});
  }
  ...
  Future<Map<String, dynamic>> verifyEmailChange(Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> disableAccount(String password) async {
    ...
    return _post('/api/v1/account/settings/account/disable', body: {'password': password});
  }

  /// POST /api/v1/account/settings/account/delete
  Future<Map<String, dynamic>> deleteAccount(String password) async {
    debugPrint('[LOOPS API] deleteAccount: starting request');
    return _post('/api/v1/account/settings/account/delete', body: {'password': password});
  }
  ...
  Future<Map<String, dynamic>> addProfileLink({required String title, required String url}) async {
    debugPrint('[LOOPS API] addProfileLink: starting request');
    return _post('/api/v1/account/settings/links/add', body: {'title': title, 'url': url});
  }
  ...
  Future<Map<String, dynamic>> enablePushNotifications(Map<String, dynamic> body) async {
    debugPrint('[LOOPS API] enablePushNotifications: starting request');
    return _post('/api/v1/account/settings/push-notifications/enable', body: body);
  }
  ...
  Future<Map<String, dynamic>> updateStarterKitsStatus(Map<String, dynamic> body) async {
  ...
  /// POST /api/v1/report
  Future<Map<String, dynamic>> submitReport({required String type, required String id, required String key, String? comment}) async {
    debugPrint('[LOOPS API] submitReport: starting request for type=$type id=$id');
  ...
  Future<Map<String, dynamic>> createStarterKit(Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> updateStarterKit(String id, Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> getStarterKitAccounts(String id) async {
    debugPrint('[LOOPS API] getStarterKitAccounts: starting request for id=$id');
    return _get('/api/v1/starter-kits/details/$id/accounts');
  }

  /// DELETE /api/v1/starter-kits/details/{id}/accounts/{accountId}
  Future<Map<String, dynamic>> removeAccountFromStarterKit(String kitId, String accountId) async {
  ...
  Future<Map<String, dynamic>> handleKitMembership(String id, Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> addAccountToStarterKit(String kitId, Map<String, dynamic> body) async {
    debugPrint('[LOOPS API] addAccountToStarterKit: starting request');
    return _post('/api/v1/starter-kits/details/$kitId/accounts/add', body: body);
  }

  /// POST /api/v1/starter-kits/details/{id}/icon (multipart)
  Future<Map<String, dynamic>> uploadStarterKitIcon(String id, String filePath) async {
    debugPrint('[LOOPS API] uploadStarterKitIcon: starting multipart upload for id=$id');
    final request = http.MultipartRequest('POST', _uri('/api/v1/starter-kits/details/$id/icon'));
  ...
  Future<Map<String, dynamic>> uploadStarterKitHeader(String id, String filePath) async {
    debugPrint('[LOOPS API] uploadStarterKitHeader: starting multipart upload for id=$id');
    final request = http.MultipartRequest('POST', _uri('/api/v1/starter-kits/details/$id/header'));
  ...
  Future<Map<String, dynamic>> deleteStarterKitHeader(String id) async {
    debugPrint('[LOOPS API] deleteStarterKitHeader: starting request for id=$id');
  ...
  Future<Map<String, dynamic>> searchStarterKitAccounts(String query) async {
    ...
    return _post('/api/v1/starter-kits/compose/search/accounts', body: {'q': query});
  }
  ...
  Future<Map<String, dynamic>> searchStarterKitHashtags(String query) async {
    ...
    return _post('/api/v1/starter-kits/compose/search/hashtags', body: {'q': query});
  }

  /// POST /api/v1/starter-kits/edit/search/accounts/{id}
  Future<Map<String, dynamic>> searchStarterKitEditAccounts(String kitId, String query) async {
    debugPrint('[LOOPS API] searchStarterKitEditAccounts: starting request');
    return _post('/api/v1/starter-kits/edit/search/accounts/$kitId', body: {'q': query});
  }
  ...
  Future<Map<String, dynamic>> browseStarterKits({String sort = 'popular', int limit = 6, String? tag, String? search, String? cursor}) async {
  ...
  Future<Map<String, dynamic>> getStarterKitsByHashtag({required String tag, String sort = 'popular', String? cursor}) async {
    debugPrint('[LOOPS API] getStarterKitsByHashtag: starting request for tag=$tag');
  ...
  Future<Map<String, dynamic>> updateDataSettings(Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> requestSelectiveExport(Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> registerViaInvite(Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> verifyAgeInvite(Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> registerResendEmail(Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> registerVerifyEmail(Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> registerClaimUsername(Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> registerVerifyAge(Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> initiateEmailVerification(Map<String, dynamic> body) async {
    debugPrint('[LOOPS API] initiateEmailVerification: starting request');
    return _post('/api/v1/auth/verify/email', body: body);
  }

  /// POST /api/v1/auth/verify/email/confirm
  Future<Map<String, dynamic>> confirmEmailVerification(Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> resendEmailVerificationExisting(Map<String, dynamic> body) async {
  ...
  Future<Map<String, dynamic>> getPrivateMediaToken(String tokenId) async {
    debugPrint('[LOOPS API] getPrivateMediaToken: starting request for tokenId=$tokenId');
