...
class DomainBlocksPage extends StatefulWidget {
  ...
  const DomainBlocksPage({Key? key, required this.apiService})
      : super(key: key);
  ...
  void _addDomain() {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(S.of(context).blockDomain,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: CyberpunkTheme.backgroundBlack,
        elevation: 0,
        title: Text(S.of(context).blockedDomains,
            style: const TextStyle(
                color: CyberpunkTheme.textWhite, fontWeight: FontWeight.w700)),
      ...
      body: _isLoading
          ...
          : _domains.isEmpty
              ? Center(
                  child: Text(S.of(context).noBlockedDomains,
                      style: const TextStyle(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () async {
                            final ok =
                                await widget.apiService.unblockDomain(domain);
                            if (ok && mounted) {
                              setState(() => _domains.removeAt(index));
                              ScaffoldMessenger.of(context)
                                  .showSnackBar(SnackBar(
                                content: Text('$domain unblocked',
                                    style:
