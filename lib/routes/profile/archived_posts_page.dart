...
class ArchivedPostsPage extends StatefulWidget {
  ...
  const ArchivedPostsPage({Key? key, required this.apiService})
      : super(key: key);
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(S.of(context).noArchivedPosts,
                          style: const TextStyle(
              ...
              : RefreshIndicator(
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final imageUrl =
                          post.hasMediaAttachments ? post.attach : '';
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: const Icon(Icons.archive_outlined,
                                    color: CyberpunkTheme.neonCyan, size: 14),
                              ),
                            ),
                          ],
                        ),
  ...
  void _showUnarchiveDialog(Status post, int index) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(S.of(context).unarchive,
            style: const TextStyle(
                color: CyberpunkTheme.textWhite, fontWeight: FontWeight.w700)),
        content: Text(S.of(context).restorePost,
            ...
            onPressed: () async {
              ...
              if (ok && mounted) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                  content: Text(S.of(context).postRestored,
                      style: const TextStyle(color: Colors.white)),
                  behavior: SnackBarBehavior.floating,
                ));
              }
            },
            child: Text(S.of(context).unarchive,
                style: const TextStyle(
                    color: CyberpunkTheme.neonCyan,
